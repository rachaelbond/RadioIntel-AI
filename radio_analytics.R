...
- While it might seem reasonable to assume that traditional radio listeners will follow similar listening patterns to the online audience, this might not necessarily be the case. \n
- All performance metrics use Z-Score comparisons rather than absolute numbers, or percentages. to account for natural variations in listening patterns throughout the day. DJ performance is measured against the average for their specific time slots, ensuring fair comparison between peak and off-peak presenters. \n
